...
/**
 * TuTrabajoAuthorizations applys the correct authorization to an operation being executed
 */
var TuTrabajoAuthorizations = module.exports.TuTrabajoAuthorizations = function (authz) {
  this.authz = authz || {};
};
 ...
 *
 */
TuTrabajoAuthorizations.prototype.add = function (name, auth) {
  if(_.isObject(name)) {
    for (var key in name) {
...
TuTrabajoAuthorizations.prototype.remove = function (name) {
  return delete this.authz[name];
};

TuTrabajoAuthorizations.prototype.apply = function (obj, securities) {
  var status = true;
